        ...
        routeInit: function(e) {
            ...
            a = {                
                ...
                routes: [				
	                ...
	                {
	                	path: "/users/query",
	                	component: "views/users/query.html",
	                	name: "用户管理"
	                },
	                {
	                	path: "/movies/add",
	                	component: "views/movies/add.html",
	                	name: "新增电影信息"
	                },
	                {
	                	path: "/movies/query",
	                	component: "views/movies/query.html",
	                	name: "电影信息查询"
	                },
	                {
	                	path: "/movies/ticket",
	                	component: "views/movies/ticket.html",
	                	name: "电影票管理"
	                },
	                {
	                	path: "/movies/orders",
	                ...
	                {
	                	path: "/news/add",
	                	component: "views/news/add.html",
	                	name: "新增站内新闻"
	                },
	                {
	                	path: "/news/query",
	                	component: "views/news/query.html",
	                	name: "站内新闻查询"
	                }
                ]
            };
